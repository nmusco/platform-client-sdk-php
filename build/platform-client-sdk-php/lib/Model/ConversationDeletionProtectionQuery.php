...
/**
 * ConversationDeletionProtectionQuery Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConversationDeletionProtectionQuery implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConversationDeletionProtectionQuery';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['conversationIds'] === null) {
            $invalidProperties[] = "'conversationIds' can't be null";
        }
     ...
     *
     * @param string[] $conversationIds list of ConversationIds
     *
     * @return $this
     */
