 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConversationDetailQueryPredicate implements ModelInterface, ArrayAccess
{
    ...
    const DIMENSION_MEDIA_STATS_MIN_CONVERSATION_MOS = 'mediaStatsMinConversationMos';
    const DIMENSION_MEDIA_STATS_MIN_CONVERSATION_R_FACTOR = 'mediaStatsMinConversationRFactor';
    const DIMENSION_ORIGINATING_DIRECTION = 'originatingDirection';
    const METRIC_N_BLIND_TRANSFERRED = 'nBlindTransferred';
    const METRIC_N_CONNECTED = 'nConnected';
    const METRIC_N_CONSULT = 'nConsult';
    const METRIC_N_CONSULT_TRANSFERRED = 'nConsultTransferred';
    const METRIC_N_ERROR = 'nError';
    const METRIC_N_FLOW = 'nFlow';
    const METRIC_N_FLOW_OUTCOME = 'nFlowOutcome';
    const METRIC_N_FLOW_OUTCOME_FAILED = 'nFlowOutcomeFailed';
    const METRIC_N_OFFERED = 'nOffered';
    const METRIC_N_OUTBOUND = 'nOutbound';
    ...
    const METRIC_N_STATE_TRANSITION_ERROR = 'nStateTransitionError';
    ...
    const METRIC_T_ALERT = 'tAlert';
    const METRIC_T_ANSWERED = 'tAnswered';
    const METRIC_T_CONTACTING = 'tContacting';
    const METRIC_T_CONVERSATION_DURATION = 'tConversationDuration';
    const METRIC_T_DIALING = 'tDialing';
    const METRIC_T_FLOW = 'tFlow';
    const METRIC_T_FLOW_DISCONNECT = 'tFlowDisconnect';
    const METRIC_T_FLOW_EXIT = 'tFlowExit';
    const METRIC_T_FLOW_OUT = 'tFlowOut';
    const METRIC_T_FLOW_OUTCOME = 'tFlowOutcome';
    const METRIC_T_HANDLE = 'tHandle';
    const METRIC_T_HELD = 'tHeld';
    const METRIC_T_HELD_COMPLETE = 'tHeldComplete';
    const METRIC_T_IVR = 'tIvr';
    const METRIC_T_NOT_RESPONDING = 'tNotResponding';
    const METRIC_T_TALK = 'tTalk';
    const METRIC_T_TALK_COMPLETE = 'tTalkComplete';
    const METRIC_T_USER_RESPONSE_TIME = 'tUserResponseTime';
    const METRIC_T_VOICEMAIL = 'tVoicemail';
     ...
     * Sets range
     *
     * @param \PureCloudPlatform\Client\V2\Model\NumericRange $range Right hand side for dimension or metric predicates
     *
     * @return $this
     */
