 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConversationQuery implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'order' => 'string',
        'orderBy' => 'string',
        'aggregations' => '\PureCloudPlatform\Client\V2\Model\AnalyticsQueryAggregation[]',
     ...
     * Sets aggregations
     *
     * @param \PureCloudPlatform\Client\V2\Model\AnalyticsQueryAggregation[] $aggregations Include faceted search and aggregate roll-ups describing your search results. This does not function as a filter, but rather, summary data about the data matching your filters
     *
     * @return $this
     */
