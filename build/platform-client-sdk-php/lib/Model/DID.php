...
class DID implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'createdByApp' => 'string',
        'phoneNumber' => 'string',
        'didPool' => '\PureCloudPlatform\Client\V2\Model\DomainEntityRef',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['didPool'] = isset($data['didPool']) ? $data['didPool'] : null;
     ...
     */
    public function getDidPool()
    {
        return $this->container['didPool'];
    }

    /**
     * Sets didPool
     *
     * @param \PureCloudPlatform\Client\V2\Model\DomainEntityRef $didPool didPool
     *
     * @return $this
     */
    public function setDidPool($didPool)
    {
        $this->container['didPool'] = $didPool;
     ...
     * Sets owner
     *
     * @param \PureCloudPlatform\Client\V2\Model\DomainEntityRef $owner A Uri reference to the owner of this DID, which is either a User or an IVR
     *
     * @return $this
     */
