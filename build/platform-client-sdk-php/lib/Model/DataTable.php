...
class DataTable implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'name' => 'string',
        'description' => 'string',
        'schema' => '\PureCloudPlatform\Client\V2\Model\JsonSchemaDocument',
        'selfUri' => 'string'
    ];
     ...
     * Sets description
     *
     * @param string $description The description from the JSON schema (equates to the Description field on the JSON schema.)
     *
     * @return $this
     */
     ...
     * Sets schema
     *
     * @param \PureCloudPlatform\Client\V2\Model\JsonSchemaDocument $schema the schema as stored in the system.
     *
     * @return $this
     */
