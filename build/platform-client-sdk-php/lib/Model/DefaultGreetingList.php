...
/**
 * DefaultGreetingList Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DefaultGreetingList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DefaultGreetingList';
    ...
    protected static $swaggerTypes = [
        'id' => 'string',
        'name' => 'string',
        'owner' => '\PureCloudPlatform\Client\V2\Model\GreetingOwner',
        'ownerType' => 'string',
        'greetings' => 'map[string,\PureCloudPlatform\Client\V2\Model\Greeting]',
     ...
     * Gets owner
     *
     * @return \PureCloudPlatform\Client\V2\Model\GreetingOwner
     */
     ...
     * Sets owner
     *
     * @param \PureCloudPlatform\Client\V2\Model\GreetingOwner $owner owner
     *
     * @return $this
     */
     ...
     * Gets greetings
     *
     * @return map[string,\PureCloudPlatform\Client\V2\Model\Greeting]
     */
     ...
     * Sets greetings
     *
     * @param map[string,\PureCloudPlatform\Client\V2\Model\Greeting] $greetings greetings
     *
     * @return $this
     */
