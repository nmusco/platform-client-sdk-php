 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EdgeLine implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EdgeLine';
    ...
    protected static $swaggerTypes = [
        ...
        'createdByApp' => 'string',
        'schema' => '\PureCloudPlatform\Client\V2\Model\DomainEntityRef',
        'properties' => 'map[string,object]',
        'edge' => '\PureCloudPlatform\Client\V2\Model\Edge',
        'edgeGroup' => '\PureCloudPlatform\Client\V2\Model\EdgeGroup',
        'lineType' => 'string',
        'endpoint' => '\PureCloudPlatform\Client\V2\Model\Endpoint',
        'ipAddress' => 'string',
    ...
    protected static $setters = [
        ...
        'logicalInterfaceId' => 'setLogicalInterfaceId',
        'selfUri' => 'setSelfUri'
    ];
    ...
    protected static $getters = [
        ...
        'logicalInterfaceId' => 'getLogicalInterfaceId',
        'selfUri' => 'getSelfUri'
    ];
    ...
    const LINE_TYPE_TIE = 'TIE';
    const LINE_TYPE_NETWORK = 'NETWORK';
    const LINE_TYPE_TRUNK = 'TRUNK';
    const LINE_TYPE_STATION = 'STATION';
    ...
    public function getLineTypeAllowableValues()
    {
        return [
            self::LINE_TYPE_TIE,
            self::LINE_TYPE_NETWORK,
            self::LINE_TYPE_TRUNK,
            self::LINE_TYPE_STATION,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['logicalInterfaceId'] = isset($data['logicalInterfaceId']) ? $data['logicalInterfaceId'] : null;
     ...
     * Sets schema
     *
     * @param \PureCloudPlatform\Client\V2\Model\DomainEntityRef $schema schema
     *
     * @return $this
     */
     ...
     * Sets edge
     *
     * @param \PureCloudPlatform\Client\V2\Model\Edge $edge edge
     *
     * @return $this
     */
     ...
     * Sets endpoint
     *
     * @param \PureCloudPlatform\Client\V2\Model\Endpoint $endpoint endpoint
     *
     * @return $this
     */
    ...
    /**
     * Gets logicalInterfaceId
     *
     * @return string
     */
    public function getLogicalInterfaceId()
    {
        return $this->container['logicalInterfaceId'];
    }

    /**
     * Sets logicalInterfaceId
     *
     * @param string $logicalInterfaceId logicalInterfaceId
     *
     * @return $this
     */
    public function setLogicalInterfaceId($logicalInterfaceId)
    {
        $this->container['logicalInterfaceId'] = $logicalInterfaceId;
