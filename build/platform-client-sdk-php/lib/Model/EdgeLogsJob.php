 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EdgeLogsJob implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EdgeLogsJob';
    ...
    protected static $swaggerTypes = [
        ...
        'createdByApp' => 'string',
        'files' => '\PureCloudPlatform\Client\V2\Model\EdgeLogsJobFile[]',
        'selfUri' => 'string'
    ];
     ...
     * Gets files
     *
     * @return \PureCloudPlatform\Client\V2\Model\EdgeLogsJobFile[]
     */
     ...
     * Sets files
     *
     * @param \PureCloudPlatform\Client\V2\Model\EdgeLogsJobFile[] $files The files available to upload from the Edge to the cloud.
     *
     * @return $this
     */
