...
/**
 * EvaluationAggregationQuery Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EvaluationAggregationQuery implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EvaluationAggregationQuery';
    ...
    protected static $swaggerTypes = [
        ...
        'timeZone' => 'string',
        'groupBy' => 'string[]',
        'filter' => '\PureCloudPlatform\Client\V2\Model\EvaluationAggregateQueryFilter',
        'metrics' => 'string[]',
        'flattenMultivaluedDimensions' => 'bool',
        'views' => '\PureCloudPlatform\Client\V2\Model\EvaluationAggregationView[]',
    ...
    const GROUP_BY_EVALUATION_CREATED_DATE = 'evaluationCreatedDate';
    ...
    const GROUP_BY_RESCIND = 'rescind';
    const GROUP_BY_RESCORED = 'rescored';
    const GROUP_BY_USER_ID = 'userId';
    const METRICS_N_EVALUATIONS = 'nEvaluations';
    const METRICS_N_EVALUATIONS_DELETED = 'nEvaluationsDeleted';
    const METRICS_N_EVALUATIONS_RESCORED = 'nEvaluationsRescored';
    const METRICS_O_TOTAL_CRITICAL_SCORE = 'oTotalCriticalScore';
    const METRICS_O_TOTAL_SCORE = 'oTotalScore';
    const ALTERNATE_TIME_DIMENSION_EVALUATION_CREATED_DATE = 'evaluationCreatedDate';
    ...
    public function getMetricsAllowableValues()
    {
        return [
            ...
            self::METRICS_N_EVALUATIONS_DELETED,
            self::METRICS_N_EVALUATIONS_RESCORED,
    ...
    {
        return [
            self::ALTERNATE_TIME_DIMENSION_EVALUATION_CREATED_DATE,
     ...
     * Gets filter
     *
     * @return \PureCloudPlatform\Client\V2\Model\EvaluationAggregateQueryFilter
     */
     ...
     * Sets filter
     *
     * @param \PureCloudPlatform\Client\V2\Model\EvaluationAggregateQueryFilter $filter Behaves like a SQL WHERE clause. This is ANDed with the interval parameter. Expresses boolean logical predicates as well as dimensional filters
     *
     * @return $this
     */
     ...
     * Gets views
     *
     * @return \PureCloudPlatform\Client\V2\Model\EvaluationAggregationView[]
     */
     ...
     * Sets views
     *
     * @param \PureCloudPlatform\Client\V2\Model\EvaluationAggregationView[] $views Custom derived metric views
     *
     * @return $this
     */
