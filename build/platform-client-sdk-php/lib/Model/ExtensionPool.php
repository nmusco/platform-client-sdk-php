...
/**
 * ExtensionPool Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExtensionPool implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExtensionPool';
     ...
     * Sets startNumber
     *
     * @param string $startNumber The starting phone number for the range of this Extension pool. Must be in E.164 format
     *
     * @return $this
     */
     ...
     * Sets endNumber
     *
     * @param string $endNumber The ending phone number for the range of this Extension pool. Must be in E.164 format
     *
     * @return $this
     */
