...
/**
 * ExternalDataSource Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExternalDataSource implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExternalDataSource';
     ...
     * Sets platform
     *
     * @param string $platform The platform that was the source of the data.  Example: a CRM like SALESFORCE.
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string $url An URL that links to the source record that contributed data to the associated entity.
     *
     * @return $this
     */
