...
/**
 * GenerateWeekScheduleRequest Class Doc Comment
 *
 * @category Class
 * @description Request to generate a week schedule
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GenerateWeekScheduleRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GenerateWeekScheduleRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shortTermForecastId'] === null) {
            $invalidProperties[] = "'shortTermForecastId' can't be null";
        }
     ...
     * Sets description
     *
     * @param string $description Description for the generated week schedule
     *
     * @return $this
     */
     ...
     *
     * @param string $shortTermForecastId ID of short term forecast used for schedule generation
     *
     * @return $this
     */
