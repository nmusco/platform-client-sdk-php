...
/**
 * GroupsSearchResponse Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupsSearchResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GroupsSearchResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'nextPage' => 'string',
        'types' => 'string[]',
        'results' => '\PureCloudPlatform\Client\V2\Model\Group[]'
    ];
     ...
     * Sets results
     *
     * @param \PureCloudPlatform\Client\V2\Model\Group[] $results Search results
     *
     * @return $this
     */
