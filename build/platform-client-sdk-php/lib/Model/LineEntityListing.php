...
/**
 * LineEntityListing Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LineEntityListing implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LineEntityListing';
    ...
    protected static $swaggerTypes = [
        'entities' => '\PureCloudPlatform\Client\V2\Model\Line[]',
        'pageSize' => 'int',
        'pageNumber' => 'int',
        'total' => 'int',
        'selfUri' => 'string',
     ...
     * Sets entities
     *
     * @param \PureCloudPlatform\Client\V2\Model\Line[] $entities entities
     *
     * @return $this
     */
