...
/**
 * LocationsSearchResponse Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LocationsSearchResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LocationsSearchResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'nextPage' => 'string',
        'types' => 'string[]',
        'results' => '\PureCloudPlatform\Client\V2\Model\LocationDefinition[]'
    ];
     ...
     * Sets results
     *
     * @param \PureCloudPlatform\Client\V2\Model\LocationDefinition[] $results Search results
     *
     * @return $this
     */
