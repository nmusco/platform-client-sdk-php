...
/**
 * MessageMediaParticipant Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MessageMediaParticipant implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MessageMediaParticipant';
     ...
     * Sets toAddress
     *
     * @param \PureCloudPlatform\Client\V2\Model\Address $toAddress Address for the participant on receiving side of the message conversation. If the address is a phone number, E.164 format is recommended.
     *
     * @return $this
     */
     ...
     * Sets fromAddress
     *
     * @param \PureCloudPlatform\Client\V2\Model\Address $fromAddress Address for the participant on the sending side of the message conversation. If the address is a phone number, E.164 format is recommended.
     *
     * @return $this
     */
     ...
     * Sets messages
     *
     * @param \PureCloudPlatform\Client\V2\Model\MessageDetails[] $messages Message instance details on the communication.
     *
     * @return $this
     */
