...
/**
 * OutboundRoute Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OutboundRoute implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OutboundRoute';
    ...
    protected static $swaggerTypes = [
        ...
        'enabled' => 'bool',
        'distribution' => 'string',
        'externalTrunkBases' => '\PureCloudPlatform\Client\V2\Model\DomainEntityRef[]',
    ...
    protected static $attributeMap = [
        ...
        'externalTrunkBases' => 'externalTrunkBases',
        'site' => 'site',
        'managed' => 'managed',
        'selfUri' => 'selfUri'
    ];
    ...
    protected static $setters = [
        ...
        'externalTrunkBases' => 'setExternalTrunkBases',
        'site' => 'setSite',
        'managed' => 'setManaged',
        'selfUri' => 'setSelfUri'
    ];
    ...
    protected static $getters = [
        ...
        'externalTrunkBases' => 'getExternalTrunkBases',
        'site' => 'getSite',
        'managed' => 'getManaged',
        'selfUri' => 'getSelfUri'
    ];
    ...
    const DISTRIBUTION_SEQUENTIAL = 'SEQUENTIAL';
     ...
     * @return string[]
     */
    public function getDistributionAllowableValues()
    {
        return [
            self::DISTRIBUTION_SEQUENTIAL,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['classificationTypes'] = isset($data['classificationTypes']) ? $data['classificationTypes'] : null;
        $this->container['enabled'] = isset($data['enabled']) ? $data['enabled'] : null;
        $this->container['distribution'] = isset($data['distribution']) ? $data['distribution'] : null;
        $this->container['externalTrunkBases'] = isset($data['externalTrunkBases']) ? $data['externalTrunkBases'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['classificationTypes'] === null) {
            $invalidProperties[] = "'classificationTypes' can't be null";
        }
        $allowedValues = $this->getDistributionAllowableValues();
        if (!is_null($this->container['distribution']) && !in_array($this->container['distribution'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'distribution', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     *
     * @param string[] $classificationTypes The site associated to the outbound route.
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getDistributionAllowableValues();
        if (!is_null($distribution) && !in_array($distribution, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'distribution', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    /**
     * Gets externalTrunkBases
     *
     * @return \PureCloudPlatform\Client\V2\Model\DomainEntityRef[]
     */
    public function getExternalTrunkBases()
    {
        return $this->container['externalTrunkBases'];
    }

    /**
     * Sets externalTrunkBases
     *
     * @param \PureCloudPlatform\Client\V2\Model\DomainEntityRef[] $externalTrunkBases Trunk base settings of trunkType \"EXTERNAL\".  This base must also be set on an edge logical interface for correct routing.
     *
     * @return $this
     */
    public function setExternalTrunkBases($externalTrunkBases)
    {
        $this->container['externalTrunkBases'] = $externalTrunkBases;
     ...
     * Sets site
     *
     * @param \PureCloudPlatform\Client\V2\Model\Site $site The site associated to the outbound route.
     *
     * @return $this
     */
     ...
     * Sets managed
     *
     * @param bool $managed Is this outbound route being managed remotely.
     *
     * @return $this
     */
