...
/**
 * RoleDivision Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RoleDivision implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RoleDivision';
     ...
     * Sets roleId
     *
     * @param string $roleId Role to be associated with the given division which forms a grant
     *
     * @return $this
     */
     ...
     * Sets divisionId
     *
     * @param string $divisionId Division associated with the given role which forms a grant
     *
     * @return $this
     */
