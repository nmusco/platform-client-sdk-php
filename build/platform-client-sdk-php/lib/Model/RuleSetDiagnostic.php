 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RuleSetDiagnostic implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'ruleSet' => '\PureCloudPlatform\Client\V2\Model\DomainEntityRef',
        'warnings' => 'string[]'
    ];
     ...
     * Sets ruleSet
     *
     * @param \PureCloudPlatform\Client\V2\Model\DomainEntityRef $ruleSet A campaign rule set
     *
     * @return $this
     */
    ...
    public function setWarnings($warnings)
    {
        ...
        if (!is_null($warnings) && array_diff($warnings, $allowedValues)) {
