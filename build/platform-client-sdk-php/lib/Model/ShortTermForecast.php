...
/**
 * ShortTermForecast Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShortTermForecast implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ShortTermForecast';
    ...
    protected static $swaggerTypes = [
        ...
        'sourceData' => '\PureCloudPlatform\Client\V2\Model\ListWrapperForecastSourceDayPointer',
        'referenceStartDate' => '\DateTime',
        'modifications' => '\PureCloudPlatform\Client\V2\Model\ListWrapperWfmForecastModification',
        'generationResults' => '\PureCloudPlatform\Client\V2\Model\ForecastGenerationResult',
        'selfUri' => 'string'
    ];
     ...
     * Gets sourceData
     *
     * @return \PureCloudPlatform\Client\V2\Model\ListWrapperForecastSourceDayPointer
     */
     ...
     * Sets sourceData
     *
     * @param \PureCloudPlatform\Client\V2\Model\ListWrapperForecastSourceDayPointer $sourceData The source data references and metadata for this forecast
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $referenceStartDate ISO-8601 date that serves as the reference date for interval-based modifications
     *
     * @return $this
     */
     ...
     * Gets modifications
     *
     * @return \PureCloudPlatform\Client\V2\Model\ListWrapperWfmForecastModification
     */
     ...
     * Sets modifications
     *
     * @param \PureCloudPlatform\Client\V2\Model\ListWrapperWfmForecastModification $modifications The modifications that have been applied to this forecast
     *
     * @return $this
     */
     ...
     *
     * @return \PureCloudPlatform\Client\V2\Model\ForecastGenerationResult
     */
     ...
     *
     * @param \PureCloudPlatform\Client\V2\Model\ForecastGenerationResult $generationResults Forecast generation results, if applicable
     *
     * @return $this
     */
