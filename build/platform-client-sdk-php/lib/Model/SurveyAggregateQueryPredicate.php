...
/**
 * SurveyAggregateQueryPredicate Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SurveyAggregateQueryPredicate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SurveyAggregateQueryPredicate';
    ...
    const DIMENSION_SURVEY_ANSWER_ID = 'surveyAnswerId';
    const DIMENSION_SURVEY_CREATED_DATE = 'surveyCreatedDate';
    const DIMENSION_SURVEY_ERROR_REASON = 'surveyErrorReason';
    const DIMENSION_SURVEY_FORM_CONTEXT_ID = 'surveyFormContextId';
    const DIMENSION_SURVEY_FORM_ID = 'surveyFormId';
    const DIMENSION_SURVEY_FORM_NAME = 'surveyFormName';
    const DIMENSION_SURVEY_ID = 'surveyId';
    const DIMENSION_SURVEY_PREVIOUS_STATUS = 'surveyPreviousStatus';
    const DIMENSION_SURVEY_PROMOTER_SCORE = 'surveyPromoterScore';
    const DIMENSION_SURVEY_QUESTION_GROUP_ID = 'surveyQuestionGroupId';
    const DIMENSION_SURVEY_QUESTION_ID = 'surveyQuestionId';
    const DIMENSION_SURVEY_STATUS = 'surveyStatus';
    ...
    public function getDimensionAllowableValues()
    {
        return [
            ...
            self::DIMENSION_SURVEY_CREATED_DATE,
