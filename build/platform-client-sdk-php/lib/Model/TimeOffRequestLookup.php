...
/**
 * TimeOffRequestLookup Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TimeOffRequestLookup implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TimeOffRequestLookup';
     ...
     * Sets id
     *
     * @param string $id The id of the time off request
     *
     * @return $this
     */
     ...
     * Sets user
     *
     * @param \PureCloudPlatform\Client\V2\Model\User $user The user that the time off request belongs to
     *
     * @return $this
     */
