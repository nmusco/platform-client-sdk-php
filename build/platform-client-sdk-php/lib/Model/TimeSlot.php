...
class TimeSlot implements ModelInterface, ArrayAccess
{
     ...
     * Sets startTime
     *
     * @param string $startTime start time in xx:xx:xx.xxx format
     *
     * @return $this
     */
     ...
     * Sets stopTime
     *
     * @param string $stopTime stop time in xx:xx:xx.xxx format
     *
     * @return $this
     */
     ...
     * Sets day
     *
     * @param int $day Day for this time slot, Monday = 1 ... Sunday = 7
     *
     * @return $this
     */
