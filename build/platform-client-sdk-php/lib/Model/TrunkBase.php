 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TrunkBase implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['trunkMetabase'] === null) {
            $invalidProperties[] = "'trunkMetabase' can't be null";
        }
        if ($this->container['trunkType'] === null) {
            $invalidProperties[] = "'trunkType' can't be null";
        }
     ...
     * Sets trunkMetabase
     *
     * @param \PureCloudPlatform\Client\V2\Model\DomainEntityRef $trunkMetabase The meta-base this trunk is based on.
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getTrunkTypeAllowableValues();
        if (!in_array($trunkType, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'trunkType', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Sets managed
     *
     * @param bool $managed Is this trunk being managed remotely. This property is synchronized with the managed property of the Edge Group to which it is assigned.
     *
     * @return $this
     */
