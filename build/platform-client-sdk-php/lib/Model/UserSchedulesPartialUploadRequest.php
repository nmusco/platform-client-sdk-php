...
/**
 * UserSchedulesPartialUploadRequest Class Doc Comment
 *
 * @category Class
 * @description Request to upload partial set of user schedules
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserSchedulesPartialUploadRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserSchedulesPartialUploadRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['userSchedules'] === null) {
            $invalidProperties[] = "'userSchedules' can't be null";
        }
     ...
     * Sets userSchedules
     *
     * @param map[string,\PureCloudPlatform\Client\V2\Model\UserSchedule] $userSchedules User schedules that are part of partial request
     *
     * @return $this
     */
