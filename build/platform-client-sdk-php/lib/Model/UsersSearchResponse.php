...
/**
 * UsersSearchResponse Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UsersSearchResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UsersSearchResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'nextPage' => 'string',
        'types' => 'string[]',
        'results' => '\PureCloudPlatform\Client\V2\Model\User[]'
    ];
     ...
     * Sets results
     *
     * @param \PureCloudPlatform\Client\V2\Model\User[] $results Search results
     *
     * @return $this
     */
