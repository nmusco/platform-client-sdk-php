 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VoicemailUserPolicy implements ModelInterface, ArrayAccess
{
     ...
     * Sets enabled
     *
     * @param bool $enabled Whether the user has voicemail enabled
     *
     * @return $this
     */
     ...
     *
     * @param int $alertTimeoutSeconds The number of seconds to ring the user's phone before a call is transfered to voicemail
     *
     * @return $this
     */
     ...
     * Sets pin
     *
     * @param string $pin The user's PIN to access their voicemail. This property is only used for updates and never provided otherwise to ensure security
     *
     * @return $this
     */
