...
/**
 * WebChatMessage Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WebChatMessage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WebChatMessage';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bodyType'] === null) {
            $invalidProperties[] = "'bodyType' can't be null";
        }
    ...
    {
        $allowedValues = $this->getBodyTypeAllowableValues();
        if (!in_array($bodyType, $allowedValues, true)) {
