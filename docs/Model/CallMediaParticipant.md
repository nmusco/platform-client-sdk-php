...
**group** | [**\PureCloudPlatform\Client\V2\Model\DomainEntityRef**](DomainEntityRef.md) | The group involved in the group ring call. | [optional] 
...
**faxStatus** | [**\PureCloudPlatform\Client\V2\Model\FaxStatus**](FaxStatus.md) | Extra fax information if the call is a fax. | [optional] 
