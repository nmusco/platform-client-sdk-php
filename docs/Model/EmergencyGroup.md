...
**emergencyCallFlows** | [**\PureCloudPlatform\Client\V2\Model\EmergencyCallFlow[]**](EmergencyCallFlow.md) | The emergency call flow(s) to use during an emergency. | [optional] 
