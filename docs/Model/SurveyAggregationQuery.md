...
**filter** | [**\PureCloudPlatform\Client\V2\Model\SurveyAggregateQueryFilter**](SurveyAggregateQueryFilter.md) | Behaves like a SQL WHERE clause. This is ANDed with the interval parameter. Expresses boolean logical predicates as well as dimensional filters | [optional] 
...
**views** | [**\PureCloudPlatform\Client\V2\Model\SurveyAggregationView[]**](SurveyAggregationView.md) | Custom derived metric views | [optional] 
