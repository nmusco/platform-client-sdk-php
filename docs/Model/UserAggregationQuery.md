...
**filter** | [**\PureCloudPlatform\Client\V2\Model\UserAggregateQueryFilter**](UserAggregateQueryFilter.md) | Behaves like a SQL WHERE clause. This is ANDed with the interval parameter. Expresses boolean logical predicates as well as dimensional filters | [optional] 
...
**views** | [**\PureCloudPlatform\Client\V2\Model\UserAggregationView[]**](UserAggregationView.md) | Custom derived metric views | [optional] 
