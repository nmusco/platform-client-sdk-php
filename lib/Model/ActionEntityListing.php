...
/**
 * ActionEntityListing Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActionEntityListing implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ActionEntityListing';
    ...
    protected static $swaggerTypes = [
        'entities' => '\PureCloudPlatform\Client\V2\Model\Action[]',
        'pageSize' => 'int',
        'pageNumber' => 'int',
        'total' => 'int',
        'selfUri' => 'string',
     ...
     * Sets entities
     *
     * @param \PureCloudPlatform\Client\V2\Model\Action[] $entities entities
     *
     * @return $this
     */
