 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CalibrationCreate implements ModelInterface, ArrayAccess
{
     ...
     * Sets conversation
     *
     * @param \PureCloudPlatform\Client\V2\Model\Conversation $conversation The conversation to use for the calibration.
     *
     * @return $this
     */
