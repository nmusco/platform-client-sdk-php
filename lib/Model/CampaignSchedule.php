...
/**
 * CampaignSchedule Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CampaignSchedule implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CampaignSchedule';
     ...
     * Sets intervals
     *
     * @param \PureCloudPlatform\Client\V2\Model\ScheduleInterval[] $intervals A list of intervals during which to run the associated Campaign.
     *
     * @return $this
     */
     ...
     * Sets timeZone
     *
     * @param string $timeZone The time zone for this CampaignSchedule. For example, Africa/Abidjan.
     *
     * @return $this
     */
     ...
     * Sets campaign
     *
     * @param \PureCloudPlatform\Client\V2\Model\DomainEntityRef $campaign The Campaign that this CampaignSchedule is for.
     *
     * @return $this
     */
