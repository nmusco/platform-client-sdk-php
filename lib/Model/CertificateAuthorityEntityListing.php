...
/**
 * CertificateAuthorityEntityListing Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CertificateAuthorityEntityListing implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CertificateAuthorityEntityListing';
    ...
    protected static $swaggerTypes = [
        'entities' => '\PureCloudPlatform\Client\V2\Model\DomainCertificateAuthority[]',
        'pageSize' => 'int',
        'pageNumber' => 'int',
        'total' => 'int',
        'selfUri' => 'string',
     ...
     * Gets entities
     *
     * @return \PureCloudPlatform\Client\V2\Model\DomainCertificateAuthority[]
     */
     ...
     * Sets entities
     *
     * @param \PureCloudPlatform\Client\V2\Model\DomainCertificateAuthority[] $entities entities
     *
     * @return $this
     */
