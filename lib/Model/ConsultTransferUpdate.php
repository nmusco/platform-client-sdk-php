...
/**
 * ConsultTransferUpdate Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConsultTransferUpdate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConsultTransferUpdate';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['speakTo'] === null) {
            $invalidProperties[] = "'speakTo' can't be null";
        }
     ...
     * Sets speakTo
     *
     * @param string $speakTo Determines to whom the initiating participant is speaking.
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getSpeakToAllowableValues();
        if (!in_array($speakTo, $allowedValues, true)) {
