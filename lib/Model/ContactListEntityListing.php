...
/**
 * ContactListEntityListing Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContactListEntityListing implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContactListEntityListing';
    ...
    protected static $swaggerTypes = [
        'entities' => '\PureCloudPlatform\Client\V2\Model\ContactList[]',
        'pageSize' => 'int',
        'pageNumber' => 'int',
        'total' => 'int',
        'selfUri' => 'string',
     ...
     * Gets entities
     *
     * @return \PureCloudPlatform\Client\V2\Model\ContactList[]
     */
     ...
     * Sets entities
     *
     * @param \PureCloudPlatform\Client\V2\Model\ContactList[] $entities entities
     *
     * @return $this
     */
