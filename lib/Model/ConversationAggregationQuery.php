...
/**
 * ConversationAggregationQuery Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConversationAggregationQuery implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConversationAggregationQuery';
    ...
    protected static $swaggerTypes = [
        ...
        'timeZone' => 'string',
        'groupBy' => 'string[]',
        'filter' => '\PureCloudPlatform\Client\V2\Model\ConversationAggregateQueryFilter',
        'metrics' => 'string[]',
        'flattenMultivaluedDimensions' => 'bool',
        'views' => '\PureCloudPlatform\Client\V2\Model\ConversationAggregationView[]',
    ...
    const METRICS_T_SHORT_ABANDON = 'tShortAbandon';
     ...
     * Gets filter
     *
     * @return \PureCloudPlatform\Client\V2\Model\ConversationAggregateQueryFilter
     */
     ...
     * Sets filter
     *
     * @param \PureCloudPlatform\Client\V2\Model\ConversationAggregateQueryFilter $filter Behaves like a SQL WHERE clause. This is ANDed with the interval parameter. Expresses boolean logical predicates as well as dimensional filters
     *
     * @return $this
     */
     ...
     * Gets views
     *
     * @return \PureCloudPlatform\Client\V2\Model\ConversationAggregationView[]
     */
     ...
     * Sets views
     *
     * @param \PureCloudPlatform\Client\V2\Model\ConversationAggregationView[] $views Custom derived metric views
     *
     * @return $this
     */
