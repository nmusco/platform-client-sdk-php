 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocumentationSearchCriteria implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'value' => 'string',
        'operator' => 'string',
        'group' => '\PureCloudPlatform\Client\V2\Model\DocumentationSearchCriteria[]',
        'type' => 'string'
    ];
     ...
     * Sets group
     *
     * @param \PureCloudPlatform\Client\V2\Model\DocumentationSearchCriteria[] $group Groups multiple conditions
     *
     * @return $this
     */
