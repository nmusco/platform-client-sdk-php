...
/**
 * EdgeLogsJobFile Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EdgeLogsJobFile implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EdgeLogsJobFile';
    ...
    const UPLOAD_STATUS_NOT_UPLOADED = 'NOT_UPLOADED';
    const UPLOAD_STATUS_UPLOADED = 'UPLOADED';
    const UPLOAD_STATUS_ERROR_ON_UPLOAD = 'ERROR_ON_UPLOAD';
    ...
    public function getUploadStatusAllowableValues()
    {
        return [
            ...
            self::UPLOAD_STATUS_NOT_UPLOADED,
            self::UPLOAD_STATUS_UPLOADED,
            self::UPLOAD_STATUS_ERROR_ON_UPLOAD,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['timeModified'] = isset($data['timeModified']) ? $data['timeModified'] : null;
        ...
        $this->container['edgePath'] = isset($data['edgePath']) ? $data['edgePath'] : null;
     ...
     * Sets timeCreated
     *
     * @param \DateTime $timeCreated Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ
     *
     * @return $this
     */
     ...
     * Sets timeModified
     *
     * @param \DateTime $timeModified The time this log file was last modified on the Edge. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ
     *
     * @return $this
     */
     ...
     * Sets sizeBytes
     *
     * @param double $sizeBytes The size of this file in bytes.
     *
     * @return $this
     */
     ...
     * Sets uploadStatus
     *
     * @param string $uploadStatus The status of the upload of this file from the Edge to the cloud.  Use /upload to start an upload.
     *
     * @return $this
     */
     ...
     * @return string
     */
    public function getEdgePath()
    {
        return $this->container['edgePath'];
    }

    /**
     * Sets edgePath
     *
     * @param string $edgePath The path of this file on the Edge.
     *
     * @return $this
     */
    public function setEdgePath($edgePath)
    {
        $this->container['edgePath'] = $edgePath;
     ...
     * Sets downloadId
     *
     * @param string $downloadId The download ID to use with the downloads API.
     *
     * @return $this
     */
