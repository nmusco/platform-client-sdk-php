...
/**
 * EdgeServiceStateRequest Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EdgeServiceStateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EdgeServiceStateRequest';
    ...
    protected static $swaggerFormats = [
        'inService' => null,
        'callDrainingWaitTimeSeconds' => 'int32'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['inService'] === null) {
            $invalidProperties[] = "'inService' can't be null";
        }
     ...
     * Sets inService
     *
     * @param bool $inService A boolean that sets the Edge in-service or out-of-service.
     *
     * @return $this
     */
     ...
     *
     * @param int $callDrainingWaitTimeSeconds The number of seconds to wait for call draining to complete before initiating the reboot. A value of 0 will prevent call draining and all calls will disconnect immediately.
     *
     * @return $this
     */
