...
class ErrorDetails implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'code' => 'string',
        'contextId' => 'string',
        'nested' => '\PureCloudPlatform\Client\V2\Model\ErrorDetails',
        'details' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['nested'] = isset($data['nested']) ? $data['nested'] : null;
     ...
     * Sets nested
     *
     * @param \PureCloudPlatform\Client\V2\Model\ErrorDetails $nested nested
     *
     * @return $this
     */
