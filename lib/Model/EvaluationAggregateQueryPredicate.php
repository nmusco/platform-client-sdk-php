...
/**
 * EvaluationAggregateQueryPredicate Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EvaluationAggregateQueryPredicate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EvaluationAggregateQueryPredicate';
    ...
    const DIMENSION_EVALUATION_CREATED_DATE = 'evaluationCreatedDate';
    ...
    const DIMENSION_RESCIND = 'rescind';
