...
/**
 * EvaluationDetailQueryPredicate Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EvaluationDetailQueryPredicate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EvaluationDetailQueryPredicate';
    ...
    const DIMENSION_CALIBRATION_ID = 'calibrationId';
    const DIMENSION_CONTEXT_ID = 'contextId';
    const DIMENSION_DELETED = 'deleted';
    ...
    const DIMENSION_RESCORED = 'rescored';
