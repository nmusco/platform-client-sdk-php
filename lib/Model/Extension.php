...
class Extension implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'createdByApp' => 'string',
        'number' => 'string',
        'owner' => '\PureCloudPlatform\Client\V2\Model\DomainEntityRef',
        'extensionPool' => '\PureCloudPlatform\Client\V2\Model\DomainEntityRef',
        'ownerType' => 'string',
        'selfUri' => 'string'
    ];
    ...
    protected static $setters = [
        ...
        'number' => 'setNumber',
        'owner' => 'setOwner',
        'extensionPool' => 'setExtensionPool',
    ...
    protected static $getters = [
        ...
        'number' => 'getNumber',
        'owner' => 'getOwner',
        'extensionPool' => 'getExtensionPool',
    ...
    const OWNER_TYPE_PHONE = 'PHONE';
    const OWNER_TYPE_IVR_CONFIG = 'IVR_CONFIG';
    ...
    public function getOwnerTypeAllowableValues()
    {
        return [
            ...
            self::OWNER_TYPE_PHONE,
            self::OWNER_TYPE_IVR_CONFIG,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['extensionPool'] = isset($data['extensionPool']) ? $data['extensionPool'] : null;
     ...
     * Sets owner
     *
     * @param \PureCloudPlatform\Client\V2\Model\DomainEntityRef $owner A Uri reference to the owner of this extension, which is either a User or an IVR
     *
     * @return $this
     */
     ...
     * @return \PureCloudPlatform\Client\V2\Model\DomainEntityRef
     */
    public function getExtensionPool()
    {
        return $this->container['extensionPool'];
    }

    /**
     * Sets extensionPool
     *
     * @param \PureCloudPlatform\Client\V2\Model\DomainEntityRef $extensionPool extensionPool
     *
     * @return $this
     */
    public function setExtensionPool($extensionPool)
    {
        $this->container['extensionPool'] = $extensionPool;
    ...
    {
        $allowedValues = $this->getOwnerTypeAllowableValues();
        if (!is_null($ownerType) && !in_array($ownerType, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'ownerType', must be one of '%s'",
                    implode("', '", $allowedValues)
