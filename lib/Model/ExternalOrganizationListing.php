...
/**
 * ExternalOrganizationListing Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExternalOrganizationListing implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExternalOrganizationListing';
    ...
    protected static $swaggerTypes = [
        'entities' => '\PureCloudPlatform\Client\V2\Model\ExternalOrganization[]',
        'pageSize' => 'int',
        'pageNumber' => 'int',
        'total' => 'int',
        'selfUri' => 'string',
     ...
     * Sets entities
     *
     * @param \PureCloudPlatform\Client\V2\Model\ExternalOrganization[] $entities entities
     *
     * @return $this
     */
