...
/**
 * HistoryListing Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HistoryListing implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HistoryListing';
    ...
    protected static $swaggerTypes = [
        ...
        'started' => '\DateTime',
        'completed' => '\DateTime',
        'entities' => '\PureCloudPlatform\Client\V2\Model\HistoryEntry[]',
        'total' => 'int',
        'pageSize' => 'int',
        'pageNumber' => 'int',
        'pageCount' => 'int'
     ...
     * Sets started
     *
     * @param \DateTime $started Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ
     *
     * @return $this
     */
     ...
     * Sets completed
     *
     * @param \DateTime $completed Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ
     *
     * @return $this
     */
     ...
     * Gets entities
     *
     * @return \PureCloudPlatform\Client\V2\Model\HistoryEntry[]
     */
     ...
     * Sets entities
     *
     * @param \PureCloudPlatform\Client\V2\Model\HistoryEntry[] $entities entities
     *
     * @return $this
     */
