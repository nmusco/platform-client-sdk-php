...
/**
 * InboundMessageRequest Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InboundMessageRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InboundMessageRequest';
     ...
     * Sets provider
     *
     * @param string $provider The name of the provider that is sourcing the email such as Oracle, Salesforce, etc.
     *
     * @return $this
     */
