...
/**
 * IntradayForecastData Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IntradayForecastData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IntradayForecastData';
     ...
     * Sets offered
     *
     * @param double $offered The number of interactions routed into the queue for the given media type(s) for an agent to answer
     *
     * @return $this
     */
     ...
     *
     * @param double $averageTalkTimeSeconds The average time in seconds an agent spends interacting with a customer
     *
     * @return $this
     */
