 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LocationSearchRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'expand' => 'string[]',
        'query' => '\PureCloudPlatform\Client\V2\Model\LocationSearchCriteria[]'
    ];
     ...
     * Sets query
     *
     * @param \PureCloudPlatform\Client\V2\Model\LocationSearchCriteria[] $query query
     *
     * @return $this
     */
