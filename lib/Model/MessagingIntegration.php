...
/**
 * MessagingIntegration Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MessagingIntegration implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MessagingIntegration';
     ...
     * Sets messengerType
     *
     * @param string $messengerType The type of Messaging Integration
     *
     * @return $this
     */
     ...
     * Sets recipient
     *
     * @param \PureCloudPlatform\Client\V2\Model\DomainEntityRef $recipient The recipient associated to the Integration. This recipient is used to associate a flow to an integration
     *
     * @return $this
     */
