...
/**
 * MessagingStickerEntityListing Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MessagingStickerEntityListing implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MessagingStickerEntityListing';
    ...
    protected static $swaggerTypes = [
        'entities' => '\PureCloudPlatform\Client\V2\Model\MessagingSticker[]',
        'pageSize' => 'int',
        'pageNumber' => 'int',
        'total' => 'int',
        'selfUri' => 'string',
     ...
     * Gets entities
     *
     * @return \PureCloudPlatform\Client\V2\Model\MessagingSticker[]
     */
     ...
     * Sets entities
     *
     * @param \PureCloudPlatform\Client\V2\Model\MessagingSticker[] $entities entities
     *
     * @return $this
     */
