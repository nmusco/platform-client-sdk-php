 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PhoneBase implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PhoneBase';
    ...
    protected static $swaggerTypes = [
        ...
        'lines' => '\PureCloudPlatform\Client\V2\Model\LineBase[]',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['phoneMetaBase'] === null) {
            $invalidProperties[] = "'phoneMetaBase' can't be null";
        }
     ...
     * Sets phoneMetaBase
     *
     * @param \PureCloudPlatform\Client\V2\Model\DomainEntityRef $phoneMetaBase A phone metabase is essentially a database for storing phone configuration settings, which simplifies the configuration process.
     *
     * @return $this
     */
     ...
     * Gets lines
     *
     * @return \PureCloudPlatform\Client\V2\Model\LineBase[]
     */
     ...
     * Sets lines
     *
     * @param \PureCloudPlatform\Client\V2\Model\LineBase[] $lines The list of linebases associated with the phone base.
     *
     * @return $this
     */
