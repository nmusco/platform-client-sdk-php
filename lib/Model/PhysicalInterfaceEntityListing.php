...
/**
 * PhysicalInterfaceEntityListing Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PhysicalInterfaceEntityListing implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PhysicalInterfaceEntityListing';
    ...
    protected static $swaggerTypes = [
        'entities' => '\PureCloudPlatform\Client\V2\Model\DomainPhysicalInterface[]',
        'pageSize' => 'int',
        'pageNumber' => 'int',
        'total' => 'int',
        'selfUri' => 'string',
     ...
     * Gets entities
     *
     * @return \PureCloudPlatform\Client\V2\Model\DomainPhysicalInterface[]
     */
     ...
     * Sets entities
     *
     * @param \PureCloudPlatform\Client\V2\Model\DomainPhysicalInterface[] $entities entities
     *
     * @return $this
     */
