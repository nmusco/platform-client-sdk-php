...
/**
 * PostInputContract Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PostInputContract implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PostInputContract';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['inputSchema'] === null) {
     ...
     * Sets inputSchema
     *
     * @param \PureCloudPlatform\Client\V2\Model\JsonSchemaDocument $inputSchema JSON Schema that defines the body of the request that the client (edge/architect/postman) is sending to the service, on the /execute path.
     *
     * @return $this
     */
