...
/**
 * QueueMediaAssociation Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class QueueMediaAssociation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QueueMediaAssociation';
     ...
     * Sets id
     *
     * @param string $id The reference ID for this QueueMediaAssociation
     *
     * @return $this
     */
     ...
     * Sets queue
     *
     * @param \PureCloudPlatform\Client\V2\Model\QueueReference $queue The queue to associate with the service goal group
     *
     * @return $this
     */
     ...
     * Sets mediaTypes
     *
     * @param string[] $mediaTypes The media types of the given queue to associate with the service goal group
     *
     * @return $this
     */
     ...
     * Sets delete
     *
     * @param bool $delete If marked true on a PATCH, this QueueMediaAssociation will be permanently deleted
     *
     * @return $this
     */
