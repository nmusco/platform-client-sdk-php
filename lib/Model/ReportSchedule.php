...
class ReportSchedule implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'lastRun' => '\PureCloudPlatform\Client\V2\Model\ReportRunEntry',
        'selfUri' => 'string'
    ];
    ...
    protected static $swaggerFormats = [
        'id' => null,
        'name' => null,
        'quartzCronExpression' => null,
        'nextFireTime' => 'date-time',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['quartzCronExpression'] === null) {
            $invalidProperties[] = "'quartzCronExpression' can't be null";
        }
     ...
     * Sets lastRun
     *
     * @param \PureCloudPlatform\Client\V2\Model\ReportRunEntry $lastRun lastRun
     *
     * @return $this
     */
