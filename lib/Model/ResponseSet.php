 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResponseSet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResponseSet';
    ...
    protected static $swaggerTypes = [
        ...
        'version' => 'int',
        'responses' => 'map[string,\PureCloudPlatform\Client\V2\Model\Reaction]',
        'selfUri' => 'string'
    ];
     ...
     * Sets name
     *
     * @param string $name The name of the ResponseSet.
     *
     * @return $this
     */
     ...
     * Gets responses
     *
     * @return map[string,\PureCloudPlatform\Client\V2\Model\Reaction]
     */
     ...
     * Sets responses
     *
     * @param map[string,\PureCloudPlatform\Client\V2\Model\Reaction] $responses Map of disposition identifiers to reactions. For example: {\"disposition.classification.callable.person\": {\"reactionType\": \"transfer\"}}.
     *
     * @return $this
     */
