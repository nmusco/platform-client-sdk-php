...
/**
 * ScimGroupListResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ScimGroupListResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScimGroupListResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'startIndex' => 'int',
        'itemsPerPage' => 'int',
        'resources' => '\PureCloudPlatform\Client\V2\Model\ScimV2Group[]',
        'schemas' => 'string[]'
    ];
     ...
     * Sets resources
     *
     * @param \PureCloudPlatform\Client\V2\Model\ScimV2Group[] $resources The list of requested resources. If \"count\" is 0, then the list will be empty.
     *
     * @return $this
     */
