...
/**
 * ScimUserListResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ScimUserListResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScimUserListResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'startIndex' => 'int',
        'itemsPerPage' => 'int',
        'resources' => '\PureCloudPlatform\Client\V2\Model\ScimV2User[]',
        'schemas' => 'string[]'
    ];
     ...
     * Sets resources
     *
     * @param \PureCloudPlatform\Client\V2\Model\ScimV2User[] $resources The list of requested resources. If \"count\" is 0, then the list will be empty.
     *
     * @return $this
     */
