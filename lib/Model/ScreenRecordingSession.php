...
/**
 * ScreenRecordingSession Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ScreenRecordingSession implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScreenRecordingSession';
     ...
     *
     * @param string $communicationId The id of the communication that is being recorded on the conversation
     *
     * @return $this
     */
     ...
     * Sets startTime
     *
     * @param \DateTime $startTime Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ
     *
     * @return $this
     */
