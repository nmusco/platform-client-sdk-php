...
/**
 * SuggestSearchCriteria Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SuggestSearchCriteria implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SuggestSearchCriteria';
    ...
    protected static $swaggerTypes = [
        ...
        'value' => 'string',
        'operator' => 'string',
        'group' => '\PureCloudPlatform\Client\V2\Model\SuggestSearchCriteria[]'
    ];
     ...
     * Sets group
     *
     * @param \PureCloudPlatform\Client\V2\Model\SuggestSearchCriteria[] $group Groups multiple conditions
     *
     * @return $this
     */
