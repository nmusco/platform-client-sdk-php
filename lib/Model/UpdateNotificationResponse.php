...
class UpdateNotificationResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateNotificationResponse';
     ...
     * Sets mutableGroupId
     *
     * @param string $mutableGroupId The mutableGroupId of the notification
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param string $id The id of the notification for mapping the potentially new mutableGroupId
     *
     * @return $this
     */
