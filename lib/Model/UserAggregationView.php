...
/**
 * UserAggregationView Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserAggregationView implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserAggregationView';
    ...
    const TARGET_T_AGENT_ROUTING_STATUS = 'tAgentRoutingStatus';
    const TARGET_T_ORGANIZATION_PRESENCE = 'tOrganizationPresence';
    const TARGET_T_SYSTEM_PRESENCE = 'tSystemPresence';
    ...
    {
        return [
            self::TARGET_T_AGENT_ROUTING_STATUS,
            self::TARGET_T_ORGANIZATION_PRESENCE,
            self::TARGET_T_SYSTEM_PRESENCE,
        ];
    }
