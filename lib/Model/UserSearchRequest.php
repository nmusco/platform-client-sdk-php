...
/**
 * UserSearchRequest Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserSearchRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserSearchRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'expand' => 'string[]',
        'query' => '\PureCloudPlatform\Client\V2\Model\UserSearchCriteria[]'
    ];
     ...
     * Sets query
     *
     * @param \PureCloudPlatform\Client\V2\Model\UserSearchCriteria[] $query query
     *
     * @return $this
     */
