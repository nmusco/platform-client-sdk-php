...
/**
 * VoicemailSearchRequest Class Doc Comment
 *
 * @category Class
 * @package  PureCloudPlatform\Client\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VoicemailSearchRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VoicemailSearchRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'expand' => 'string[]',
        'query' => '\PureCloudPlatform\Client\V2\Model\VoicemailSearchCriteria[]'
    ];
     ...
     * Sets query
     *
     * @param \PureCloudPlatform\Client\V2\Model\VoicemailSearchCriteria[] $query query
     *
     * @return $this
     */
