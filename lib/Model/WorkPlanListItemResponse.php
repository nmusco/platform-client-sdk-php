...
/**
 * WorkPlanListItemResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WorkPlanListItemResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WorkPlanListItemResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'shifts' => '\PureCloudPlatform\Client\V2\Model\WorkPlanShift[]',
        'agents' => '\PureCloudPlatform\Client\V2\Model\DeletableUserReference[]',
     ...
     * Sets optionalDays
     *
     * @param \PureCloudPlatform\Client\V2\Model\SetWrapperDayOfWeek $optionalDays Optional days to schedule for this work plan. Populate with expand=details
     *
     * @return $this
     */
     ...
     *
     * @param \PureCloudPlatform\Client\V2\Model\ListWrapperShiftStartVariance $shiftStartVariances Variance in minutes among start times of shifts in this work plan. Populate with expand=details
     *
     * @return $this
     */
     ...
     * Gets shifts
     *
     * @return \PureCloudPlatform\Client\V2\Model\WorkPlanShift[]
     */
     ...
     * Sets shifts
     *
     * @param \PureCloudPlatform\Client\V2\Model\WorkPlanShift[] $shifts Shifts in this work plan. Populate with expand=details (defaults to empty list)
     *
     * @return $this
     */
     ...
     * Gets agents
     *
     * @return \PureCloudPlatform\Client\V2\Model\DeletableUserReference[]
     */
     ...
     * Sets agents
     *
     * @param \PureCloudPlatform\Client\V2\Model\DeletableUserReference[] $agents Agents in this work plan. Populate with expand=details (defaults to empty list)
     *
     * @return $this
     */
     ...
     * Sets agentCount
     *
     * @param int $agentCount Number of agents in this work plan.  Populate with expand=agentCount
     *
     * @return $this
     */
